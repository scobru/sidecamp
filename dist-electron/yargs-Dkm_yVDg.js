...
import { c as init_yerror, n as init_esm, s as YError, t as esm_default } from "./esm-mqkNxq_0.js";
...
var init_apply_extends = __esmMin((() => {
	init_yerror();
	previouslyVisitedConfigs = [];
}));
//#endregion
...
var init_common_types = __esmMin((() => {}));
//#endregion
...
var init_parse_command = __esmMin((() => {}));
//#endregion
...
var init_maybe_async_result = __esmMin((() => {
	init_is_promise();
}));
//#endregion
...
var init_which_module = __esmMin((() => {}));
//#endregion
...
var init_set_blocking = __esmMin((() => {}));
//#endregion
...
var init_completion_templates = __esmMin((() => {
...
var init_yargs_factory = __esmMin((() => {
	init_command();
	init_common_types();
	init_yerror();
	init_usage();
	...
	YargsInstance = class {
		...
		coerce(keys, value) {
			...
			__classPrivateFieldGet(this, _YargsInstance_globalMiddleware, "f").addCoerceMiddleware((argv, yargs) => {
				let aliases;
				if (!Object.prototype.hasOwnProperty.call(argv, keys)) return argv;
				return maybeAsyncResult(() => {
					...
					if (aliases[keys] && stripAliased !== true) for (const alias of aliases[keys]) argv[alias] = result;
					return argv;
				}, (err) => {
