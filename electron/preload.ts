...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  setTrackAnalysis: (filePath: string, data: { bpm?: number; peaks?: number[]; beatOffset?: number; cuePoint?: number }) => ipcRenderer.invoke('downloads:set-analysis', filePath, data),
